...
<nav class="navbar navbar-expand-md bg-dark navbar-dark">
  <a class="navbar-brand" href="#"><h2>Covid 19 Plasma Therapy</h2></a>
...
<br>
        <style>
            body{
                background-image: url('Human-red-blood-cells.jpg');
                }
            .modal-header{
                color: black;
                }
...
<!-- <div class="view" style="background-image: url('blood.jpeg'); 
            ...
            <div class="row">
                ...
                <div class="container p-3 my-3 border">
                    <div class="text-center" style="width:200px">
                        <img class="img-fluid" src="images/donate_blood_1119.jpg" alt="Card image" style="width:100%">
                ...
                <div class="container p-3 my-3 border">
                    <div class="text-center" style="width:200px">
                        <img class="img-fluid" src="images/hos.png" alt="Card image" style="width:100%">
